...
export const dummyRecipesData: Recipe[] = [
  ...
  },
  {
    ...
    description: "A simple and delicious guacamole recipe that's perfect for any occasion.",
    imageUrl: "/placeholders/guacamole-hero.jpg",
    prepTime: "10 minutes",
    cookTime: "0 minutes",
    servings: 4,
    ingredients: [
    ...
    instructions: [
      {
        stepNumber: 1,
        description: "Cut the avocados in half, remove the pits, and scoop the flesh into a medium bowl.",
      },
      {
        stepNumber: 2,
        description: "Mash the avocado with a fork to your desired consistency (chunky or smooth).",
      },
      {
        stepNumber: 3,
        description: "Add the lime juice, cilantro, red onion, jalapeño (if using), salt, and cumin. Stir to combine.",
      },
      {
        stepNumber: 4,
        description: "Taste and adjust seasonings if necessary. Serve immediately with tortilla chips or your favorite dippers.",
      },
    ],
  ...
  },
  {
    ...
    imageUrl: "/placeholders/chicken-stir-fry-hero.jpg",
    prepTime: "15 minutes",
    cookTime: "10-12 minutes",
    servings: 4,
    ingredients: [
      { name: "boneless, skinless chicken breasts", quantity: "1 lb", notes: "cut into 1-inch pieces" },
      ...
      { name: "carrots", quantity: "1 cup", notes: "julienned or thinly sliced" },
    ...
    instructions: [
      {
        stepNumber: 1,
        description: "In a small bowl, whisk together soy sauce, honey, sesame oil, and cornstarch. Set aside.",
      },
      {
        stepNumber: 2,
        description: "Heat olive oil in a large skillet or wok over medium-high heat. Add chicken and cook until browned and cooked through. Remove chicken from skillet and set aside.",
      },
      {
        stepNumber: 3,
        description: "Add broccoli, bell peppers, and carrots to the skillet. Stir-fry for 3-5 minutes until tender-crisp.",
      },
      {
        stepNumber: 4,
        description: "Add garlic and ginger to the skillet and cook for 1 minute until fragrant.",
      },
      {
        stepNumber: 5,
        description: "Return chicken to the skillet. Pour the sauce over everything and cook, stirring constantly, until the sauce has thickened and coats the chicken and vegetables.",
      },
      {
        stepNumber: 6,
  ...
  },
  {
    ...
    imageUrl: "/placeholders/caprese-salad-hero.jpg",
    prepTime: "10 minutes",
    cookTime: "0 minutes",
    servings: 4,
    ingredients: [
      { name: "ripe tomatoes", quantity: "2 large", notes: "sliced 1/4-inch thick" },
      { name: "fresh mozzarella cheese", quantity: "8 oz", notes: "sliced 1/4-inch thick" },
  ...
  },
  {
    ...
    description: "A delicious and easy recipe for moist banana bread that's perfect for using up ripe bananas.",
    imageUrl: "/placeholders/banana-bread-hero.jpg",
    prepTime: "15 minutes",
    ...
    ingredients: [
      ...
      { name: "walnuts or pecans", quantity: "1/2 cup", notes: "chopped (optional)" },
    ],
    instructions: [
      {
        stepNumber: 1,
        description: "Preheat oven to 350°F (175°C). Grease and flour a 9x5 inch loaf pan.",
      },
      {
        stepNumber: 2,
        description: "In a medium bowl, whisk together flour, baking soda, salt, and cinnamon.",
      },
      {
        stepNumber: 3,
        description: "In a large bowl, combine mashed bananas, melted butter, sugar, egg, and vanilla extract. Mix well.",
      },
      {
        stepNumber: 4,
        description: "Gradually add the dry ingredients to the wet ingredients, mixing until just combined. Do not overmix. Fold in nuts if using.",
      },
      {
        stepNumber: 5,
        description: "Pour batter into the prepared loaf pan and spread evenly.",
      },
      {
        stepNumber: 6,
        description: "Bake for 60-65 minutes, or until a toothpick inserted into the center comes out clean. If the top starts to brown too quickly, you can loosely tent it with aluminum foil.",
      },
      {
        stepNumber: 7,
        description: "Let the banana bread cool in the pan for 10 minutes before transferring it to a wire rack to cool completely.",
      },
    ],
  ...
  },
  {
    ...
    description: "A succulent and flavorful roast chicken seasoned with lemon and herbs, perfect for a family dinner.",
    imageUrl: "/placeholders/roast-chicken-hero.jpg",
    prepTime: "20 minutes",
    ...
    ingredients: [
      ...
      { name: "onion", quantity: "1", notes: "quartered (optional, for roasting pan)" },
      { name: "carrots", quantity: "2", notes: "roughly chopped (optional, for roasting pan)" },
    ],
    instructions: [
      {
        stepNumber: 1,
        description: "Preheat oven to 425°F (220°C). Remove giblets from chicken cavity and pat the chicken dry with paper towels.",
      },
      {
        stepNumber: 2,
        description: "Season the cavity of the chicken generously with salt and pepper. Stuff the cavity with lemon halves, smashed garlic cloves, rosemary sprigs, and thyme sprigs.",
      },
      {
        stepNumber: 3,
        description: "Rub the outside of the chicken with olive oil and season generously with salt and pepper.",
      },
      {
        stepNumber: 4,
        description: "Place onion and carrots in the bottom of a roasting pan if desired. Place the chicken on top of the vegetables or directly in the pan.",
      },
      {
        stepNumber: 5,
        description: "Roast for 15 minutes at 425°F (220°C). Then, reduce the oven temperature to 375°F (190°C) and continue roasting for another 60-75 minutes, or until the internal temperature of the thickest part of the thigh reaches 165°F (74°C) and juices run clear.",
      },
      {
        stepNumber: 6,
        description: "Let the chicken rest for 10-15 minutes before carving. This allows the juices to redistribute, resulting in a more tender chicken.",
      },
    ],
    sourceUrl: "https://www.inspiredtaste.net/23801/easy-whole-roast-chicken-recipe/",
